...
typedef bool (*ParseStopFunc)(TokenKind);
...
Token *parser_expect_next(Parser *parser, TokenKind kind);
bool parser_next_is(Parser *parser, TokenKind kind);
bool parser_next_is_not(Parser *parser, TokenKind kind);
Token *parser_next_is_not_or(Parser *parser, TokenKind kind);
Token *parser_next_is_or(Parser *parser, TokenKind kind);
